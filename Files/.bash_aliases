...
alias kcw='watch -n 0.2 unbuffer kubecolor get all --output wide'
alias kcg='kubecolor get'
alias kcy='kubecolor get --output yaml'
...
alias kcgn='kubecolor get nodes'
alias kcdp='kubecolor describe pod'
alias kcdn='kubecolor describe node'
alias kcyp='kubecolor get pod --output yaml'
alias kcdl='kubecolor delete'
alias kcaf='kubecolor apply --filename'
alias kcdf='kubecolor delete --filename'
alias kcgw='watch --interval 0.2 unbuffer kubecolor get'
alias kcdw='watch --interval 0.2 unbuffer kubecolor describe'
alias kcgpw='watch --interval 0.2 unbuffer kubecolor get pods'
alias kcgpg='kubecolor get pods | grep'
alias kcdlp='kubecolor delete pod'
alias kcew='watch --interval 0.2 unbuffer kubecolor events --for'
alias gs='git status'
alias gl='git pull'
alias gp='git push'
alias gd='git diff'
...
kcdpw()
{
    watch --interval 0.2 unbuffer kubecolor events --for pod/${1}
}
...
complete -F _kcdpw -o default -o bashdefault kcdpw
...
kcgpgw()
{
    watch --interval 0.2 "unbuffer kubecolor get pods | grep ${1}"
}
...
sshc()
{
    ...
    for match in $(ssh-keygen -F ${host} | grep "found:" | awk '{ print $6 }')
    do
        sed -i '' -e "$((${match} - ${idx}))d" ~/.ssh/known_hosts
        idx=$((${idx} + 1))
    done
}
